 ...
 */
class  Blogmax_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class  Blogmax_Dropdown_Category_Control extends WP_Customize_Control {
...
class  Blogmax_Note_Control extends WP_Customize_Control {
...
class  Blogmax_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class  Blogmax_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="blogmax-chosen-select" <?php $this->link(); ?>>
                    <?php
...
class  Blogmax_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="blogmax-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class  Blogmax_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class  Blogmax_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="blogmax-sortable-list">
 
      <?php
       foreach ( $values_choices as $value ){  ?>
	        <li>
	            <input class="blogmax-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
	            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
	          <i class="dashicons dashicons-menu blogmax-drag-handle"></i>
	        </li>
        ...
        <li class="sortable-hideme">
          <input class="blogmax-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
Class  Blogmax_Customize_Horizontal_Line extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class  Blogmax_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Blogmax_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
